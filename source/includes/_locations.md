...
fields | false | Columns for search at database level, only permit this columns: 'name', 'address', 'timezone'
...
address | false | Address for that place, **if you want the weather forecast it's necesary**
...
organization_id | true | Identifier of an organization you are targeting
name | true | Name for the place
address | false | Address for that place,**if you need the weather forecast it's required**
timezone | false | Timezone for that place, you need insert with TZ DB format
async_weather | false | Boolean to indicate if you need the weather forecast
